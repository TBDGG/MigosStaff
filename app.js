// ====== ХЭШ ======
function simpleHash(s){var h=0;for(var i=0;i<s.length;i++){h=((h<<5)-h)+s.charCodeAt(i);h=h&h}return'h_'+Math.abs(h).toString(36)}

// ====== ТЕМЫ ======
var tg={'Геймерские':['minecraft','cyberpunk','fantasy','retro'],'Однотонные':['dark','dark-blue','dark-green','dark-red','dark-purple','light','light-blue']}
var themes={minecraft:{name:'⛏ Minecraft',isGamer:!0,bg:'#1a0a0a',bg2:'#241510',card:'#2d1810',card2:'#3d1c1c',border:'#5c3a1e',accent:'#ffd700',accent2:'#d4a574',text:'#f0e6d2',text2:'#a89070',input:'#2d1810',hover:'#3d1c1c',danger:'#503030',dangerHover:'#301515',success:'#305030',successText:'#74d474'},cyberpunk:{name:'🤖 Киберпанк',isGamer:!0,bg:'#0a0a0f',bg2:'#0f0f1a',card:'#151525',card2:'#1a1a30',border:'#303050',accent:'#00ffff',accent2:'#00cccc',text:'#e0e0ff',text2:'#7070a0',input:'#151525',hover:'#1a1a30',danger:'#503030',dangerHover:'#301515',success:'#305030',successText:'#74d474'},fantasy:{name:'🧙 Фэнтези',isGamer:!0,bg:'#0f0a14',bg2:'#1a1020',card:'#1a1525',card2:'#251a30',border:'#4a3060',accent:'#c084fc',accent2:'#a855f7',text:'#e0d5f0',text2:'#8070a0',input:'#1a1525',hover:'#251a30',danger:'#503030',dangerHover:'#301515',success:'#305030',successText:'#74d474'},retro:{name:'🕹️ Ретро',isGamer:!0,bg:'#1a1a0a',bg2:'#242410',card:'#2d2d10',card2:'#3d3d1c',border:'#5c5c1e',accent:'#ffd700',accent2:'#ffaa00',text:'#f0f0d2',text2:'#909070',input:'#2d2d10',hover:'#3d3d1c',danger:'#503030',dangerHover:'#301515',success:'#305030',successText:'#74d474'},dark:{name:'🌙 Тёмная',isGamer:!1,bg:'#0a0a0f',bg2:'#0a0a0f',card:'#151520',card2:'#1a1a28',border:'#2a2a3a',accent:'#d4a574',accent2:'#b8946c',text:'#d0d0d0',text2:'#808090',input:'#151520',hover:'#1a1a28',danger:'#402020',dangerHover:'#301515',success:'#204020',successText:'#74d474'},'dark-blue':{name:'💙 Тёмно-синяя',isGamer:!1,bg:'#0a0f14',bg2:'#0a0f14',card:'#151a20',card2:'#1a2028',border:'#2a3040',accent:'#74a4d4',accent2:'#5a8ab4',text:'#c0d0e0',text2:'#708090',input:'#151a20',hover:'#1a2028',danger:'#402020',dangerHover:'#301515',success:'#204020',successText:'#74d474'},'dark-green':{name:'💚 Тёмно-зелёная',isGamer:!1,bg:'#0a140a',bg2:'#0a140a',card:'#152015',card2:'#1a281a',border:'#2a402a',accent:'#74d474',accent2:'#5ab45a',text:'#c0e0c0',text2:'#709070',input:'#152015',hover:'#1a281a',danger:'#402020',dangerHover:'#301515',success:'#204020',successText:'#74d474'},'dark-red':{name:'❤️ Тёмно-красная',isGamer:!1,bg:'#140a0a',bg2:'#140a0a',card:'#201515',card2:'#281a1a',border:'#402a2a',accent:'#d47474',accent2:'#b45a5a',text:'#e0c0c0',text2:'#907070',input:'#201515',hover:'#281a1a',danger:'#402020',dangerHover:'#301515',success:'#204020',successText:'#74d474'},'dark-purple':{name:'💜 Тёмно-фиолетовая',isGamer:!1,bg:'#0f0a14',bg2:'#0f0a14',card:'#1a1520',card2:'#201a28',border:'#302a40',accent:'#a484d4',accent2:'#8a6ab4',text:'#d0c0e0',text2:'#807090',input:'#1a1520',hover:'#201a28',danger:'#402020',dangerHover:'#301515',success:'#204020',successText:'#74d474'},light:{name:'☀️ Светлая',isGamer:!1,bg:'#f0f0f0',bg2:'#f0f0f0',card:'#ffffff',card2:'#f5f5f5',border:'#d0d0d0',accent:'#8b5a2b',accent2:'#6b4020',text:'#303030',text2:'#707070',input:'#ffffff',hover:'#f0f0f0',danger:'#ffe0e0',dangerHover:'#ffd0d0',success:'#e0ffe0',successText:'#30a030'},'light-blue':{name:'💡 Светло-синяя',isGamer:!1,bg:'#f0f4f8',bg2:'#f0f4f8',card:'#ffffff',card2:'#f5f8fa',border:'#d0d8e0',accent:'#4a8ab4',accent2:'#3a6a94',text:'#304050',text2:'#607080',input:'#ffffff',hover:'#f0f4f8',danger:'#ffe0e0',dangerHover:'#ffd0d0',success:'#e0ffe0',successText:'#30a030'}}

var fg={'Игровые':['Press Start 2P','Russo One','Rubik Mono One'],'Обычные':['Inter','Roboto','Montserrat','Rubik']}
var fonts={'Press Start 2P':{name:'🎮 Pixel',import:'Press+Start+2P',family:'"Press Start 2P",cursive'},'Russo One':{name:'🎯 Russo',import:'Russo+One',family:'"Russo One",sans-serif'},'Rubik Mono One':{name:'🧊 Rubik Mono',import:'Rubik+Mono+One',family:'"Rubik Mono One",sans-serif'},Inter:{name:'📝 Inter',import:'Inter:wght@400;600',family:'"Inter",sans-serif'},Roboto:{name:'📄 Roboto',import:'Roboto:wght@400;700',family:'"Roboto",sans-serif'},Montserrat:{name:'📋 Montserrat',import:'Montserrat:wght@400;600',family:'"Montserrat",sans-serif'},Rubik:{name:'📃 Rubik',import:'Rubik:wght@400;600',family:'"Rubik",sans-serif'}}

var cT=localStorage.getItem('theme')||'dark',cF=localStorage.getItem('font')||'Press Start 2P'
...
function showLoading(t,cb,d){var a=document.getElementById('app');if(!a)return;a.innerHTML='<div style="display:flex;align-items:center;justify-content:center;min-height:400px"><div style="text-align:center"><div style="font-size:48px;animation:bounce 0.6s ease infinite alternate">⛏️</div><div style="color:var(--accent);font-size:var(--font-size-lg);margin-top:20px">'+(t||'Загрузка...')+'</div></div></div>';if(cb)setTimeout(cb,d||1500)}
function saveSession(){if(currentUser)localStorage.setItem('currentUser',JSON.stringify(currentUser))}
function loadSession(){var s=localStorage.getItem('currentUser');if(s)try{currentUser=JSON.parse(s);return!0}catch(e){}return!1}
...
// ====== ЗАРПЛАТА ======
async function recalcSalary(uid){var r=await supabase.from('users').select('*,roles(*)').eq('id',uid).single();if(!r.data)return;var u=r.data,ro=u.roles,np=0;if(ro&&ro.salary_value>0){if(ro.salary_type==='hourly')np=(u.play_hours||0)*ro.salary_value;else np=(u.play_hours||0)>0?ro.salary_value:0}await supabase.from('users').update({pending_salary:np}).eq('id',uid)}
async function paySalary(uid){var r=await supabase.from('users').select('*').eq('id',uid).single();if(!r.data)return;var u=r.data,p=u.pending_salary||0;if(p<=0)return;await supabase.from('users').update({balance:(u.balance||0)+p,issued_salary:(u.issued_salary||0)+p,pending_salary:0}).eq('id',uid);await supabase.from('salary_history').insert({user_id:uid,amount:p,type:'salary',month:cm()});var s=await supabase.from('monthly_stats').select('*').eq('user_id',uid).eq('month',cm()).single();if(s.data)await supabase.from('monthly_stats').update({salary:p}).eq('id',s.data.id);else await supabase.from('monthly_stats').insert({user_id:uid,month:cm(),play_hours:u.play_hours||0,salary:p,warns:u.warns||0,bonuses:0});if(uid===currentUser.id){currentUser.balance+=p;currentUser.issued_salary+=p;currentUser.pending_salary=0;saveSession()}notify('💳','Зарплата выдана: '+p+'₽','success');showUserProfile(uid)}

// ====== РЕНДЕР ======
function renderLogin(){return'<div class="form-card"><h2>⚡ Вход</h2><div class="form-group"><label>Никнейм</label><input id="login-username" autocomplete="off"/></div><div class="form-group"><label>Пароль</label><input id="login-password" type="password" autocomplete="off"/></div><div id="login-error" class="error-msg"></div><button onclick="handleLogin()">Войти</button><div class="form-links"><a onclick="navigateTo(\'register\')">Регистрация</a></div></div>'}
function renderRegister(){var o='<option value="">Выберите режим...</option>';for(var i=0;i<modes.length;i++)o+='<option value="'+modes[i].name+'">'+modes[i].name+'</option>';o+='<option value="__custom__">✏️ Свой...</option>';return'<div class="form-card"><h2>📝 Регистрация</h2><div class="form-group"><label>Никнейм</label><input id="reg-username" autocomplete="off"/></div><div class="form-group"><label>Пароль</label><input id="reg-password" type="password" autocomplete="off"/></div><div class="form-group"><label>Режим</label><select id="reg-mode" onchange="checkCustomMode()">'+o+'</select><input id="reg-custom-mode" placeholder="Свой режим..." style="display:none;margin-top:10px"/></div><div id="reg-error" class="error-msg"></div><div id="reg-success" class="success-msg"></div><button onclick="handleRegister()">Зарегистрироваться</button><div class="form-links"><a onclick="navigateTo(\'login\')">Войти</a></div></div>'}
function checkCustomMode(){var s=document.getElementById('reg-mode'),c=document.getElementById('reg-custom-mode');if(s&&c)c.style.display=s.value==='__custom__'?'block':'none'}
...
async function loadUsers(){
  var c=document.getElementById('tab-content');if(!c)return;c.innerHTML='<div style="text-align:center;padding:20px;color:var(--text2)">Загрузка...</div>'
  var rr=await supabase.from('roles').select('*').order('priority',{ascending:!1});roles=rr.data||[]
  var q=supabase.from('users').select('*,roles(*)').eq('is_approved',!0).eq('is_blocked',!1)
  if(!currentUser.is_super_admin&&currentUser.admin_mode)q=q.eq('mode',currentUser.admin_mode)
  var r=await q
  if(r.data){users=r.data;users.sort(function(a,b){return(b.roles?b.roles.priority:0)-(a.roles?a.roles.priority:0)})
  ...
  var ml=[],mO='<option value="">Все режимы</option>'
  for(var i=0;i<users.length;i++){if(ml.indexOf(users[i].mode)===-1&&users[i].mode)ml.push(users[i].mode)}
  for(var j=0;j<ml.length;j++)mO+='<option value="'+ml[j]+'"'+(userFilter.mode===ml[j]?' selected':'')+'>'+ml[j]+'</option>'
...
async function showUserProfile(uid){
  var u=null;for(var i=0;i<users.length;i++){if(users[i].id===uid){u=users[i];break}};if(!u)return
  var c=document.getElementById('tab-content');if(!c)return;c.innerHTML='<div style="text-align:center;padding:20px;color:var(--text2)">Загрузка...</div>'
  ...
  // Должность
  if(u.id!==currentUser.id||currentUser.is_super_admin){var ro='<option value="">Без должности</option>';for(var r=0;r<ar.length;r++)ro+='<option value="'+ar[r].id+'"'+(u.role_id===ar[r].id?' selected':'')+'>'+ar[r].name+' (пр.'+ar[r].priority+')</option>'
    h+='<div class="table-container"><h3>🎨 Должность</h3><div class="form-group"><select id="profile-role" onchange="updateUserRole(\''+uid+'\')">'+ro+'</select></div></div>'}
  
  // Заметки
  if(currentUser.is_super_admin||currentUser.admin_mode){h+='<div class="table-container"><h3>📝 Заметки</h3><textarea id="admin-notes" onchange="saveAdminNotes(\''+uid+'\')" style="width:100%;height:80px;background:var(--input);border:2px solid var(--border);color:var(--text);font-family:var(--font);font-size:var(--font-size-sm);padding:10px;border-radius:var(--border-radius)">'+(u.admin_notes||'')+'</textarea></div>'}
...
async function saveContacts(uid){await supabase.from('users').update({vk_id:document.getElementById('edit-vk').value,discord:document.getElementById('edit-discord').value,forum:document.getElementById('edit-forum').value}).eq('id',uid);document.querySelector('.modal-overlay').remove();notify('✅','Контакты обновлены','success');showUserProfile(uid)}

// ====== ВАРНЫ ======
function editWarn(wid,uid){var m=document.createElement('div');m.className='modal-overlay';m.innerHTML='<div class="modal"><h3>✏️ Варн</h3><div class="form-group"><label>Причина</label><input id="edit-warn-reason"/></div><div class="form-group"><label>Штраф</label><input id="edit-warn-fine" type="number"/></div><button onclick="saveWarn(\''+wid+'\',\''+uid+'\')">💾</button> <button onclick="this.closest(\'.modal-overlay\').remove()">Отмена</button></div>';document.body.appendChild(m)}
async function saveWarn(wid,uid){await supabase.from('warns').update({reason:document.getElementById('edit-warn-reason').value,fine:parseInt(document.getElementById('edit-warn-fine').value)||0,updated_at:new Date().toISOString()}).eq('id',wid);document.querySelector('.modal-overlay').remove();notify('✅','Варн обновлён','success');showUserProfile(uid)}
async function deleteWarn(wid,uid){if(!confirm('Удалить?'))return;await supabase.from('warns').delete().eq('id',wid);var c=await supabase.from('warns').select('id',{count:'exact'}).eq('user_id',uid).eq('is_active',!0);await supabase.from('users').update({warns:c.count||0}).eq('id',uid);notify('🗑','Варн удалён','info');showUserProfile(uid)}
function editBonus(bid,uid){var m=document.createElement('div');m.className='modal-overlay';m.innerHTML='<div class="modal"><h3>✏️ Премия</h3><div class="form-group"><label>Сумма</label><input id="edit-bonus-amount" type="number"/></div><div class="form-group"><label>Причина</label><input id="edit-bonus-reason"/></div><button onclick="saveBonus(\''+bid+'\',\''+uid+'\')">💾</button> <button onclick="this.closest(\'.modal-overlay\').remove()">Отмена</button></div>';document.body.appendChild(m)}
async function saveBonus(bid,uid){await supabase.from('bonuses').update({amount:parseInt(document.getElementById('edit-bonus-amount').value)||0,reason:document.getElementById('edit-bonus-reason').value,updated_at:new Date().toISOString()}).eq('id',bid);document.querySelector('.modal-overlay').remove();notify('✅','Премия обновлена','success');showUserProfile(uid)}
async function deleteBonus(bid,uid){if(!confirm('Удалить?'))return;await supabase.from('bonuses').delete().eq('id',bid);notify('🗑','Премия удалена','info');showUserProfile(uid)}

// ====== МОДАЛКИ ======
function showWarnModal(uid){var u=null;for(var i=0;i<users.length;i++){if(users[i].id===uid){u=users[i];break}};var m=document.createElement('div');m.className='modal-overlay';m.innerHTML='<div class="modal"><h3>⚠️ Варн</h3><div class="form-group"><label>Причина</label><input id="warn-reason"/></div><div class="form-group"><label>Штраф (₽)</label><input id="warn-fine" type="number" value="100"/></div><div class="form-group"><label>Срок (дней)</label><input id="warn-days" type="number" value="0"/></div>'+(u&&u.warnings_count>=3?'<div class="form-group"><label><input type="checkbox" id="reset-warnings"/> Обнулить предупреждения ('+u.warnings_count+')</label></div>':'')+'<button onclick="issueWarn(\''+uid+'\')">Выдать</button> <button onclick="this.closest(\'.modal-overlay\').remove()">Отмена</button></div>';document.body.appendChild(m)}
async function issueWarn(uid){var r=document.getElementById('warn-reason').value,f=parseInt(document.getElementById('warn-fine').value)||0,d=parseInt(document.getElementById('warn-days').value)||0;if(!r)return;var e=null;if(d>0){var dt=new Date();dt.setDate(dt.getDate()+d);e=dt.toISOString()};await supabase.from('warns').insert({user_id:uid,reason:r,fine:f,created_by:currentUser.username,expires_at:e,is_active:!0});var u=null;for(var i=0;i<users.length;i++){if(users[i].id===uid){u=users[i];break}};var ud={warns:(u.warns||0)+1,balance:Math.max(0,(u.balance||0)-f)};var rw=document.getElementById('reset-warnings');if(rw&&rw.checked)ud.warnings_count=0;if(u)await supabase.from('users').update(ud).eq('id',uid);document.querySelector('.modal-overlay').remove();notify('⚠️','Варн выдан: '+r,'error');showUserProfile(uid)}
function showBanModal(uid){var m=document.createElement('div');m.className='modal-overlay';m.innerHTML='<div class="modal"><h3>🔒 Бан</h3><div class="form-group"><label>Причина</label><input id="ban-reason"/></div><div class="form-group"><label>Срок</label><select id="ban-duration"><option value="1h">1 час</option><option value="6h">6 ч</option><option value="1d">1 день</option><option value="3d">3 дня</option><option value="7d">7 дней</option><option value="30d">30 дней</option><option value="permanent">Навсегда</option></select></div><button onclick="issueBan(\''+uid+'\')">Бан</button> <button onclick="this.closest(\'.modal-overlay\').remove()">Отмена</button></div>';document.body.appendChild(m)}
async function issueBan(uid){var r=document.getElementById('ban-reason').value,d=document.getElementById('ban-duration').value;if(!r)return;var p=d==='permanent';await supabase.from('bans').insert({user_id:uid,reason:r,duration:p?'Навсегда':d,created_by:currentUser.username,is_permanent:p});if(p)await supabase.from('users').update({is_blocked:!0}).eq('id',uid);document.querySelector('.modal-overlay').remove();notify('🔒','Бан выдан: '+r,'error');showUserProfile(uid)}
function showBonusModal(uid){var m=document.createElement('div');m.className='modal-overlay';m.innerHTML='<div class="modal"><h3>💰 Премия</h3><div class="form-group"><label>Сумма</label><input id="bonus-amount" type="number" value="100"/></div><div class="form-group"><label>Причина</label><input id="bonus-reason"/></div><button onclick="issueBonus(\''+uid+'\')">Выдать</button> <button onclick="this.closest(\'.modal-overlay\').remove()">Отмена</button></div>';document.body.appendChild(m)}
async function issueBonus(uid){var a=parseInt(document.getElementById('bonus-amount').value)||0,r=document.getElementById('bonus-reason').value;await supabase.from('bonuses').insert({user_id:uid,amount:a,reason:r,created_by:currentUser.username});var u=null;for(var i=0;i<users.length;i++){if(users[i].id===uid){u=users[i];break}};if(u)await supabase.from('users').update({balance:(u.balance||0)+a}).eq('id',uid);document.querySelector('.modal-overlay').remove();notify('💰','Премия: +'+a+'₽','success');showUserProfile(uid)}
function showEditHoursModal(uid){var u=null;for(var i=0;i<users.length;i++){if(users[i].id===uid){u=users[i];break}};var m=document.createElement('div');m.className='modal-overlay';m.innerHTML='<div class="modal"><h3>⏱ Часы</h3><div class="form-group"><label>Количество</label><input id="edit-hours-val" type="number" value="'+(u?u.play_hours||0:0)+'"/></div><button onclick="saveHours(\''+uid+'\')">💾</button> <button onclick="this.closest(\'.modal-overlay\').remove()">Отмена</button></div>';document.body.appendChild(m)}
...
async function approveUserFromList(uid){await supabase.from('users').update({is_approved:!0}).eq('id',uid);notify('✅','Одобрен','success');loadOsly()}
async function toggleBlockFromList(uid,b){await supabase.from('users').update({is_blocked:!b}).eq('id',uid);notify(b?'🔓':'🔒',b?'Разблок':'Заблок',b?'success':'error');loadOsly()}

// ====== ЗАЯВКИ ======
async function loadRequests(){var c=document.getElementById('tab-content');if(!c)return;var q=supabase.from('purchase_requests').select('*').order('created_at',{ascending:!1});if(!currentUser.is_super_admin&&currentUser.admin_mode)q=q.eq('mode',currentUser.admin_mode);var r=await q;allRequests=r.data||[];var h='<div class="table-container"><h3>📋 Заявки ('+allRequests.length+')</h3>';if(allRequests.length===0)h+='<p style="color:var(--text2)">Нет</p>';else{h+='<table><thead><tr><th>Ник</th><th>Режим</th><th>Услуга</th><th>Цена</th><th>Статус</th><th>Дата</th><th></th></tr></thead><tbody>';for(var i=0;i<allRequests.length;i++){var req=allRequests[i],sc=req.status==='approved'?'var(--success-text)':req.status==='rejected'?'#d47474':'#ffd700',st=req.status==='approved'?'Одобрено':req.status==='rejected'?'Отклонено':'Ожидает';h+='<tr><td>'+req.username+'</td><td>'+req.mode+'</td><td>'+req.service+'</td><td>'+req.price+'₽</td><td style="color:'+sc+'">'+st+'</td><td>'+formatDate(req.created_at)+'</td><td>'+(req.status==='pending'?'<button onclick="processRequest(\''+req.id+'\',\'approved\')" style="font-size:var(--font-size-sm)">✅</button> <button onclick="processRequest(\''+req.id+'\',\'rejected\')" class="danger" style="font-size:var(--font-size-sm)">❌</button>':'')+'</td></tr>'}h+='</tbody></table>'}h+='</div>';c.innerHTML=h}
async function processRequest(rid,st){var req=null;for(var i=0;i<allRequests.length;i++){if(allRequests[i].id===rid){req=allRequests[i];break}};if(!req)return;await supabase.from('purchase_requests').update({status:st,processed_at:new Date().toISOString()}).eq('id',rid);if(st==='rejected'){var ur=await supabase.from('users').select('balance').eq('username',req.username).single();if(ur.data)await supabase.from('users').update({balance:(ur.data.balance||0)+req.price}).eq('username',req.username)}notify(st==='approved'?'✅':'❌',st==='approved'?'Заявка одобрена':'Заявка отклонена',st==='approved'?'success':'error');loadRequests()}
...
// ====== АВТОРИЗАЦИЯ ======
async function handleLogin(){var ue=document.getElementById('login-username'),pe=document.getElementById('login-password'),ee=document.getElementById('login-error'),un=ue?ue.value.trim():'',pw=pe?pe.value:'';if(!un||!pw){if(ee)ee.textContent='Заполните поля';return};showLoading('Вход...',async function(){var h=simpleHash(pw+un),r=await supabase.from('users').select('*,roles(*)').eq('username',un);if(r.error||!r.data||r.data.length===0){renderApp();var e=document.getElementById('login-error');if(e)e.textContent='Неверный ник или пароль';return};var u=r.data[0];if(u.password_hash!==h){renderApp();var e2=document.getElementById('login-error');if(e2)e2.textContent='Неверный пароль';return};if(u.is_blocked){renderApp();var e3=document.getElementById('login-error');if(e3)e3.textContent='Заблокирован';return};currentUser={id:u.id,username:u.username,mode:u.mode,position:u.position,role_id:u.role_id,is_approved:u.is_approved,is_blocked:u.is_blocked,is_super_admin:u.is_super_admin,admin_mode:u.admin_mode,play_hours:u.play_hours,warns:u.warns,notes:u.notes,balance:u.balance,issued_salary:u.issued_salary,pending_salary:u.pending_salary,vk_id:u.vk_id,discord:u.discord,forum:u.forum,admin_notes:u.admin_notes,warnings_count:u.warnings_count,role_name:u.roles?u.roles.name:null,role_color:u.roles?u.roles.color:null};saveSession();renderApp()},2000)}
async function handleRegister(){var ue=document.getElementById('reg-username'),pe=document.getElementById('reg-password'),me=document.getElementById('reg-mode'),ce=document.getElementById('reg-custom-mode'),ee=document.getElementById('reg-error'),se=document.getElementById('reg-success'),un=ue?ue.value.trim():'',pw=pe?pe.value:'',mode=me?me.value:'';if(mode==='__custom__'&&ce)mode=ce.value.trim();if(ee)ee.textContent='';if(se)se.textContent='';if(un.length<3){if(ee)ee.textContent='Ник от 3 символов';return};if(pw.length<6){if(ee)ee.textContent='Пароль от 6 символов';return};if(!mode){if(ee)ee.textContent='Выберите режим';return};var c=await supabase.from('users').select('id').eq('username',un);if(c.data&&c.data.length>0){if(ee)ee.textContent='Ник занят';return};var h=simpleHash(pw+un),ins=await supabase.from('users').insert({username:un,password_hash:h,mode:mode,balance:0,pending_salary:0,issued_salary:0,warnings_count:0});if(ins.error){if(ee)ee.textContent='Ошибка: '+ins.error.message;return};if(se)se.textContent='✅ Успешно!';setTimeout(function(){currentPage='login';renderApp()},2000)}
function handleLogout(){clearSession();currentUser=null;currentPage='login';renderApp()}
function renderApp(){var a=document.getElementById('app');if(!a)return;if(!currentUser)a.innerHTML=currentPage==='register'?renderRegister():renderLogin();else a.innerHTML=renderDashboard()}
